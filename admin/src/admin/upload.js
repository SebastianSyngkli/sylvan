                ...
                <form onSubmit={handlersubmit} className="update-form">
                    ...
                    <div className="form-group">
                        ...
                        <select id="category" onChange={(e) => setCategory(e.target.value)} value={category}>
                            ...
                            <option value="imageroom">Imageroom</option>
                            <option value="imageroomitems">Imageroomitems</option>
                            <option value="imageroomb">Imageroom-B</option>
                            <option value="imageroomitemsb">Imageroomitems-B</option>
                            <option value="imageroomc">Imageroom-C</option>
                            <option value="imageroomitemsc">Imageroomitems-c</option>
                            <option value="imageroomd">Imageroom-D</option>
                            <option value="imageroomitemsd">Imageroomitems-D</option>
                            ...
                            <option value="singlecabbin">singlecabbin</option>
                            <option value="fullcabbin">fullcabbin</option>
                            <option value="singlecabbinmainimage">Singlecabbinmain-image</option>
